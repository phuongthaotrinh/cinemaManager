            ...
            <div className="w-full h-full">
                ...
                <div className="absolute w-full top-[5%] p-4 md:p-8 ">
                    ...
                    <div className="my-7 flex items-center">
                        ...
                        <button className='border  text-white border-gray-300 px-5 py-3 ml-4 hover:bg-white hover:text-black'><Link to={`/movie/${movieRender?._id}`} className='font-bold flex items-center text-white hover:text-red-600' >Xem chi tiết</Link></button>
                    </div>
